        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        final int k=getIntent().getIntExtra("riddle",1);
                        ...
                        if (resultsView == null||bb==null) {
                            resultsView = findViewById(R.id.results);

                        }
                        if(results.size()>0&&results.get(0).getTitle().equals(String.valueOf(k)))
...
//                        Log.e("ks",results.get(0).getTitle());
